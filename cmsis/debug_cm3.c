...
ITM_Type* gITM SECT_AT(.dbg) = (ITM_Type*)ITM_BASE;
InterruptType_Type* gSCS SECT_AT(.dbg) = (InterruptType_Type*)SCS_BASE;
SysTick_Type* gSysTick SECT_AT(.dbg) = (SysTick_Type*)SysTick_BASE;
NVIC_Type* gNVIC SECT_AT(.dbg) = (NVIC_Type*)NVIC_BASE;
SCB_Type* gSCB SECT_AT(.dbg) = (SCB_Type*)SCB_BASE;
CoreDebug_Type* gCORE_DBG SECT_AT(.dbg) = (CoreDebug_Type*)CoreDebug_BASE;
