...
FORCE_C void _estack(void); // to force type checking
FORCE_C int main(void); // to force type checking

FORCE_C void default_handler(void)
{
	while (1)
		;
}
...
void Reset_Handler(void)
{
	...
	SystemInit();
	__libc_init_array(); // for C++, Constructor.
	main();
	while (1)
	{
	}
...
FORCE_C void DMA1_Channel4_IRQHandler(void) __attribute__((weak, alias("default_handler")));
FORCE_C void DMA1_Channel5_IRQHandler(void) __attribute__((weak, alias("default_handler")));
